        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-6 lg:grid-cols-2">
            {servicePages.map((service) => (
              <article key={service.slug} className="rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-900/40">
                <h2 className="text-2xl font-semibold text-zinc-950 dark:text-white">{service.title}</h2>
                <p className="mt-4 leading-7 text-zinc-600 dark:text-zinc-300">{service.summary}</p>
